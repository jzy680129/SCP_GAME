...
```powershell
blender --background --python "Assets/Tools/MixamoPipeline/Blender/batch_process_mixamo.py" -- --input "Z:/游戏资源/美术资源/Action" --output "Assets/Processed/Mixamo/Animations" --overwrite
```
