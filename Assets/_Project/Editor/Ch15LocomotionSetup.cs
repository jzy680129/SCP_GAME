...
{
    private const string ControllerPath = "Assets/_Project/Art/Common/Ch15_Locomotion.controller";
    private const string CharacterName = "Ch15_nonPBR";
    private const string IdleClipPath = "Assets/_Project/Art/Common/Ch12_nonPBR@Breathing Idle.fbx";
    private const string WalkClipPath = "Assets/_Project/Art/Common/Ch12_nonPBR@Walking.fbx";
    private const string RunClipPath = "Assets/_Project/Art/Common/Ch12_nonPBR@Standard Run.fbx";
    private const string JumpClipPath = "Assets/_Project/Art/Common/Ch12_nonPBR@Jump.fbx";
    private const string LeftStrafeClipPath = "Assets/_Project/Art/Common/Ch12_nonPBR@Left Strafe.fbx";
    private const string RightStrafeClipPath = "Assets/_Project/Art/Common/Ch12_nonPBR@Right Strafe.fbx";
