...
public static class MixamoThirdPersonSetup
{
    ...
    private const string CharacterPrefabPath = "Assets/_Project/Pipeline/Processed/Mixamo/Characters_MCP/CHR_Ch36_nonPBR.fbx";
    ...
    private const string HudUxmlPath = "Assets/_Project/UI/HUD/ThirdPersonHud.uxml";
    private const string HudPanelSettingsPath = "Assets/_Project/UI/HUD/GameHudPanelSettings.asset";
    private const string CinematicVolumeName = "CinematicPostProcessVolume";
    private const string CinematicVolumeProfilePath = "Assets/_Project/Settings/CinematicPostProcessProfile.asset";

    private static readonly string[] IdleClipPaths =
    {
        "Assets/_Project/Pipeline/Processed/Mixamo/Animations_MCP/MX_Breathing_Idle.fbx",
        "Assets/_Project/Pipeline/Processed/Mixamo/Animations_MCP/MX_Breathing_Idle_1.fbx"
    };

    private static readonly string[] JumpLandClipPaths =
    {
        "Assets/_Project/Pipeline/Processed/Mixamo/Animations_MCP/MX_Falling_To_Landing.fbx",
        "Assets/_Project/Pipeline/Processed/Mixamo/Animations_MCP/MX_Jumping_Down.fbx"
    };

    [MenuItem("Tools/Mixamo Pipeline/Configure Third Person Controller")]
    public static void Configure()
    {
        EnsureFolder("Assets/_Project/Pipeline/Processed/Mixamo", "ThirdPerson");
    ...
    private static void RebuildController(AnimatorController controller)
    {
        ...
        sprintTurn.motion = LoadAnimationClip("Assets/_Project/Pipeline/Processed/Mixamo/Animations_MCP/MX_Running_Turn_180.fbx");

        AnimatorState runningJump = stateMachine.AddState("RunningJump", new Vector3(570f, -110f, 0f));
        runningJump.writeDefaultValues = false;
        runningJump.motion = LoadAnimationClip("Assets/_Project/Pipeline/Processed/Mixamo/Animations_MCP/MX_Running_Jump.fbx");

        AnimatorState jumpAir = stateMachine.AddState("JumpAirLoop", new Vector3(880f, -110f, 0f));
        jumpAir.writeDefaultValues = false;
        jumpAir.motion = LoadAnimationClip("Assets/_Project/Pipeline/Processed/Mixamo/Animations_MCP/MX_Falling_Idle.fbx");
    ...
    private static BlendTree CreateLocomotionBlendTree(AnimatorController controller)
    {
        ...
        AddBlendChild(blendTree, LoadAnimationClip("Assets/_Project/Pipeline/Processed/Mixamo/Animations_MCP/MX_Walking.fbx"), 1f, "walk");
        AddBlendChild(blendTree, LoadAnimationClip("Assets/_Project/Pipeline/Processed/Mixamo/Animations_MCP/MX_Standard_Run.fbx"), 2f, "run");
    ...
    private static bool ConfigureHud()
    {
        ...
        EnsureFolder("Assets/_Project/UI", "HUD");
