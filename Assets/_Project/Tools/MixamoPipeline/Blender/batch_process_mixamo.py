...
blender --background --python batch_process_mixamo.py -- --input "Assets/_Project/Pipeline/Raw/Mixamo/Animations" --output "Assets/_Project/Pipeline/Processed/Mixamo/Animations"
